...
if __name__ == "__main__":
    ...
    trainset = datasets.ImageFolder('/home/dchen/dataset/MNIST/IID/train/client1/', transform=transform)
    ...
    testset = datasets.ImageFolder('/home/dchen/dataset/MNIST/IID/test/client1/', transform=transform)
